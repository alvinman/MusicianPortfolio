		...
		<div id="pageWrapper">
			...
			<div id="loginContent">
				...
				<div id="loginElements">
					<div id="loginForm">
						<form id="loginInput" name="loginForm" action="login.php" method="post">
								<p class="inputTitle">USERNAME</p>
								<input id="inputUsername" name="login" type="text" spellcheck="false">
								<p class="inputTitle">PASSWORD</p>
								<input id="inputPassword" name="password" type="password">
								<button id="loginSubmit" name="Submit" type="submit">LOGIN</button>
						</form>
					</div>

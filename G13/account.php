		...
		<div id="pageWrapper">
			...
			<div id="loginContent">
				...
				<div id="accountElements">
					<div id="accountInfo">
						<p class="accountTitle"><span class="spanAccountTitle">FIRST NAME:</span> <?php echo $_SESSION['SESS_FIRST_NAME'];?></p>
						<p class="accountTitle"><span class="spanAccountTitle">LAST NAME:</span> <?php echo $_SESSION['SESS_LAST_NAME'];?></p>
						<p class="accountTitle"><span class="spanAccountTitle">MEMBER ID:</span> <?php echo $_SESSION['SESS_MEMBER_ID'];?></p>
						<p class="accountTitle"><span class="spanAccountTitle">USERNAME:</span> <?php echo $_SESSION['SESS_USERNAME'];?></p>
						
						<div class="accountButtons"><a href="logout.php"><p>SIGN OUT</p></a></div>
						<div class="accountButtons"><a href="confirmDelete.php"><p>DELETE ACCOUNT</p></a></div>

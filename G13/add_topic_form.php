					...
					<table>
						<tr>
							<form id="form1" name="form1" method="post" action="add_topic.php">
								<td>
									<table id="newTopicTable">
										<tr>
											<td id="topicHead" colspan="3">Create New Topic</td>
										</tr>
										<tr>
											<td id="firstCol2">Topic</td>
											<td id="secondCol2"></td>
											<td id="thirdCol2"><input name="topic" type="text" id="topic" size="60
" /></td>
										</tr>
										<tr>
											<td id="detail">Detail</td>
											<td></td>
											<td><textarea name="detail" cols="85" rows="15" id="detail"></textarea></td>
										</tr>
										<tr>
											<td>&nbsp;</td>
											<td>&nbsp;</td>
